Trestle.configure do |config|
  ...
  #
  config.site_logo = "https://blog.sitnsleep.com/wp-content/uploads/2019/04/teddy-bear-1024x835.jpg"

  # Specify a custom image to be used for the collapsed/tablet navigation.
  #
  config.site_logo_small = "https://blog.sitnsleep.com/wp-content/uploads/2019/04/teddy-bear-1024x835.jpg"

  # Specify a favicon to be used within the admin.
  #
  config.favicon = "https://blog.sitnsleep.com/wp-content/uploads/2019/04/teddy-bear-1024x835.jpg"

  # Set the text shown in the page footer within the admin.
  # Defaults to 'Powered by Trestle'.
  #
   config.footer = "Powered by Administration Épic"
  ...
  config.auth.avatar = ->(user) {
    avatar(fallback: user.avatar_url) do
      image_tag(user.avatar_url, alt: user.first_name) if user.avatar_url?
    end
  }
